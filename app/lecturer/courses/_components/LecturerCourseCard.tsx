...
export function LecturerCoursecard({ data }: iAppProps) {
    ...
    <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-muted py-0 gap-0">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48">
            <DropdownMenuItem asChild>
              <Link href={`/lecturer/courses/${data.id}/edit`}>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem asChild>
              <Link href={`/lecturer/courses/${data.id}/delete`}>
      ...
      <CardContent className="p-4">
        ...
        <Link
          ...
          href={`/lecturer/courses/${data.id}/edit`}
        >
...
export function LecturerCourseCardSkeleton() {
  return (
