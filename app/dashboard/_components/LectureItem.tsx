...
export default function LectureItem({ lecture, slug, isActive, completed }: iAppProps) {
  return (
    <Link
      ...
      className={cn(
        buttonVariants({
          ...
          className: cn(
            ...
            completed &&
              "bg-green-100 dark:bg-green-900/30 border-green-300 dark:border-green-700 hover:bg-green-200 dark:hover:bg-green-900/50 text-50 text-green-800 dark:text-green-200",
